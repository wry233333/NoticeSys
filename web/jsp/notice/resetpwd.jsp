...
<html>
	...
	<body>
		<div class="container">
			<form class="form-signin" action="/resetServlet" method="post">
			        <h2 class="form-signin-heading">找回密码</h2>
			        <label for="inputEmail" class="sr-only">请输入要找回密码的邮箱：</label>
			        <input type="text" id="inputEmail" class="form-control" placeholder="请输入你的邮箱地址" name="email" required autofocus><a class="btn btn-info" style="margin-top: 10px;" onclick="f1()">获取验证码</a>
			        <label for="inputPassword" class="sr-only">请输入验证码：</label>
			        <input type="password" id="inputCheckCode" class="form-control" placeholder="请输入您的验证码" name="check-code" required>
			        ...
			        <button id="confirm" class="btn btn-lg btn-primary btn-block" type="submit" disabled="true" >重置密码</button>
			</form>
		</div>
	</body>
</html>
